...
mod test {
    ...
    test_parse!(handled_block_multiple_invert: "with {} when 'x invert {} when 'y invert {} else yield" => HandledBlock::parse => "(HandledBlock _ [(Handler::When _) (Handler::When _) (Handler::Else _)])");
