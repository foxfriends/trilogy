...
mod test {
    ...
    test_parse!(assignment_left_record: "({ \"a\" => a }) = 7" => Statement::parse => "(Statement::Assignment (AssignmentStatement _ (AssignmentStrategy::Direct _) _))");
    test_parse!(assignment_left_set: "{| a, b |} = 7" => Statement::parse => "(Statement::Assignment (AssignmentStatement _ (AssignmentStrategy::Direct _) _))");
