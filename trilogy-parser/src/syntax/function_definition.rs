...
mod test {
    ...
    test_parse!(func_one_param: "func hello x = x" => FunctionDefinition::parse => FunctionDefinition { .. });
    test_parse!(func_multi_param: "func hello x y z = x + y + z" => FunctionDefinition::parse => FunctionDefinition { .. });
    test_parse!(func_pattern_param: "func find f x:xs = if f x then x else find f xs" => FunctionDefinition::parse => FunctionDefinition { .. });
