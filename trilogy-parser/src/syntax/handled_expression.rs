...
mod test {
    ...
    test_parse_error!(handled_expr_else_invert: "with 3 else invert 3" => HandledExpression::parse);
    ...
    test_parse!(handled_expr_invert_block: "with 3 when 'x invert {} else yield" => HandledExpression::parse => "(HandledExpression _ _ [(Handler::When _) (Handler::Else _)])");
    ...
    test_parse_error!(handled_expr_invert_expr: "with 3 when 'x invert 3 else yield" => HandledExpression::parse);
    ...
    test_parse!(handled_expr_multiple_invert: "with 3 when 'x invert { 3 } when 'y invert { 3 } else yield" => HandledExpression::parse => "(HandledExpression _ _ [(Handler::When _) (Handler::When _) (Handler::Else _)])");
