...
uint64_t trilogy_array_len(trilogy_array_value* tv);
uint64_t trilogy_array_cap(trilogy_array_value* tv);
uint64_t trilogy_array_resize(trilogy_array_value* tv, uint64_t cap);
uint64_t trilogy_array_reserve(trilogy_array_value* tv, uint64_t cap);
