...
\hyphenation{non-deter-minism}
\hyphenation{non-deter-min-istic}
\hyphenation{op-erand}

\newcounter{proofno}
\newcommand{\ProofLabel}[1]{\RightLabel{\refstepcounter{proofno}\label{#1}\scriptsize{(\ref{#1})}}}

\newcommand{\todo}[1]{\marginpar{\textcolor{red}{#1}}}

\def\CC{{C\nolinebreak[4]\hspace{-.05em}\raisebox{.4ex}{\tiny\bf ++}}}

\newcommand{\tri}[1]{\lstinline[language=Trilogy]{#1}}

% TODO: see how many places we can do away with these manual ones
...
\newcommand{\setof}[1]{\{#1\}}
\newcommand{\given}{\ |\ }
\newcommand{\block}[1]{\texttt{\{}\ #1\ \texttt{\}}}
\newcommand{\defby}{:=}
\newcommand{\extends}{:>}
...
\lstdefinelanguage{Trilogy}{
    sensitive=true,
    morekeywords=[1]{proc,let,mut,break,continue,and,or,not,if,else,while,for,in,return,do,match,case,end},
    morekeywords=[2]{func,where,if,then,else,let,in,fn},
    morekeywords=[3]{rule,given,and,or,not,if,then,is},
    morekeywords=[4]{with,when,cancel,resume,invert,yield},
