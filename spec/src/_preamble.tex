...
\lstdefinelanguage{Trilogy}{
    sensitive=true,
    morekeywords=[1]{proc,let,var,mut,break,continue,or,and,if,else,loop,while,for,in,return,do,match,body},
    morekeywords=[2]{func,where,if,then,else,let,in,fn,unit},
    morekeywords=[3]{rule},
    morekeywords=[4]{when,cancel,resume,yield},
    morestring=[b]{"},
    morestring=[s]{$"}{"},
    morecomment=[l]{\#}
}

\newcommand{\inputcode}[1]{\noindent\begin{minipage}{\linewidth}\lstinputlisting[language=Trilogy]{#1}\end{minipage}}
