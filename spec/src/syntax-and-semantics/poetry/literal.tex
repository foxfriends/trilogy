...
\begin{prooftree}
    ...
    \noLine
    \UnaryInfC{$\Gamma\vdash \texttt{\{|}K_2\ \texttt{=>}\ V_2\ \texttt{,}\cdots\texttt{,}\ K_n\ \texttt{=>}\ V_n\texttt{|\}} : \ty{Record}\ \kappa\ \nu$}
    \LeftLabel{Record\textsuperscript{\op{..}}}
    \UnaryInfC{$\Gamma\vdash\texttt{\{|}\op{..}X\ \texttt{,}\ K_2\ \texttt{=>}\ V_2\ \texttt{,}\cdots\texttt{,}\ K_n\ \texttt{=>}\ V_n\texttt{|\}} : \ty{Record}\ \kappa\ \nu$}
\end{prooftree}
