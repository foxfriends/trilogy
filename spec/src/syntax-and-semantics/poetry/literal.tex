...
\begin{prooftree}
    ...
    \AxiomC{$\Gamma\vdash \texttt{[}X_2, \cdots, X_n\texttt{]} : \ty{List}\ \tau$}
    \LeftLabel{Array}
    \BinaryInfC{$\Gamma\vdash\texttt{[}X_1, X_2, \cdots, X_n\texttt{]} : \ty{List}\ \tau$}
\end{prooftree}
...
\begin{prooftree}
    ...
    \BinaryInfC{$\Gamma\vdash\texttt{[}\op{..}X_1, X_2, \cdots, X_n\texttt{]} : \ty{List}\ \tau$}
\end{prooftree}
...
\begin{prooftree}
    ...
    \LeftLabel{Record}
    \TrinaryInfC{$\Gamma\vdash\texttt{\{}K_1:V_1\ \texttt{,}\ K_2:V_2\ \texttt{,}\cdots\texttt{,}\ K_n:V_n\texttt{\}} : \ty{Record}\ \kappa:\nu$}
\end{prooftree}
...
\begin{prooftree}
    ...
    \BinaryInfC{$\Gamma\vdash\texttt{\{}\op{..}X\ \texttt{,}\ K_2:V_2\ \texttt{,}\cdots\texttt{,}\ K_n:V_n\texttt{\}} : \ty{Record}\ \kappa:\nu$}
\end{prooftree}
