...
The \kw{yield} keyword used in \Poetry{} is actually also an operator. This operator
works similarly to how the \kw{yield} statement of \Prose{} works, but the returned
