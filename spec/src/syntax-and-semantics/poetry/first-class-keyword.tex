...
Finally, the \kw{return} statement is also interesting in that it is an encoding of
...
from the function the first class keyword was bound to. If the \kw{return} escapes
