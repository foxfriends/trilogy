...
The lookup case is the most powerful of the unifications, where a rule is looked up in
(or computed from) the current scope and its definitions are applied by unifying each
parameter with the arguments provided.
