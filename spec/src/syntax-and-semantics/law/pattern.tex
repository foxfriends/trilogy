...
\begin{bnf*}
    ...
    \bnfprod{SinglePattern}{
        \bnfpn{StructuralPattern}
        \bnfsp
        \bnfpn{TypeAnnotation}
    } \\
\end{bnf*}

All patterns contain a \emph{binding} portion, and optionally a \emph{non-binding}
portion as well---currently the only non-binding option is a type annotation,
reflected in the syntax above by the lack of a $\bnfpn{NonBindingPattern}$
production.
...
typically in conjunction with the \kw{or} and \kw{and} keywords.
