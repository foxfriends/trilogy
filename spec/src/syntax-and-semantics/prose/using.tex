...
Worth noting is that the callback is truly a new function: the \kw{return} keyword
used within this callback returns to the place where the callback is called within
the \kw{using} statement's expression function. To escape back to a further scope,
a captured return from that scope must be used.
