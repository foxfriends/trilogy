...
A procedure may cause an execution to end or branch, in which case all evaluations are propgated
to the call site, conceptually causing the call to end or branch respectively.
