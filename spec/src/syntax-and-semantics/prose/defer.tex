...
The \kw{defer} statement provides the means to safely and consistently perform cleanup
...
% TODO: a defer statement could receive the final value of the continuation as a parameter
% and evaluate to a replacement continuation value? confusing and weird, but seems accurate
