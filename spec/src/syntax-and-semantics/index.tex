...
\begin{itemize}
    ...
    \item $x = y$ --- Unifies, via the unification algorithm. Given the patterns
    $x$ and $y$, find substitutions for the variables of both patterns such that
    $x$ and $y$ are the same.
    \item $a := x$ --- Declares, as a name. $x$ is a pattern and $a$ is a name
