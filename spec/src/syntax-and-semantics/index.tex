...
\begin{itemize}
    ...
    \item $X \vartriangle E$ --- Yields, as an effect. The expression $X$ causes
    an effect $E$ to be yielded. That effect may be handled later.
\end{itemize}
...
\begin{bnf}
    ...
    \bnfprod*{ModuleParameters}{\bnfpn{Identifier}\bnfsp\bnfts{,}\bnfsp\bnfpn{ModuleParameters}\bnfor} \\
    \bnfmore*{\bnfpn{Identifier}\bnfor\bnfes} \\
    \bnfprod*{Import}{
        \bnfts{\kw{import}}
        \bnfsp
