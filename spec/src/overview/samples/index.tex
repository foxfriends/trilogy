...
The \kw{given} keyword annotates an expression in which one or more facts (\kw{ft})
...
convenient packages of facts for later, all of which may appear in the \kw{given}
clause.
