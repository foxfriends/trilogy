...
pub enum InternalRuntimeError {
    ...
    /// A value was expected on the heap but something else was found.
    ExpectedHeapValue(&'static str),
...
impl Display for InternalRuntimeError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::ExpectedHeapValue(found) => write!(f, "expected value at pointer, found {found}"),
