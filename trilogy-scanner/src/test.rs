...
test_tokenize!(kw_using => "using" = [KwUsing]);
...
test_tokenize!(op_shr_ex => "~~>" = [OpShrEx]);
test_tokenize!(op_shl_ex => "<~~" = [OpShlEx]);
test_tokenize!(op_shr_ex_eq => "~~>=" = [OpShrExEq]);
test_tokenize!(op_shl_ex_eq => "<~~=" = [OpShlExEq]);
test_tokenize!(op_tilde_op_tilde => "~~" = [OpTilde OpTilde]);
test_tokenize!(op_shr_con => "~>>" = [OpShrCon]);
test_tokenize!(op_shl_con => "<<~" = [OpShlCon]);
test_tokenize!(op_shr_con_eq => "~>>=" = [OpShrConEq]);
test_tokenize!(op_shl_con_eq => "<<~=" = [OpShlConEq]);
...
test_tokenize!(integer_start_underscore => "1_000_000" = [Numeric]);
...
test_tokenize!(hex_start_underscore => "0x_0123_456_789_abc_def" = [Numeric]);
test_tokenize!(hex_start_b => "0xb1" = [Numeric]);
...
test_tokenize!(oct_start_underscores => "0o_012_34_567" = [Numeric]);
...
test_tokenize!(bin_start_underscores => "0b_0_1" = [Numeric]);
...
test_tokenize!(bits_bin_start_underscores => "0bb_01" = [Bits]);
test_tokenize!(bits_hex => "0bx0123456789abcdef" = [Bits]);
test_tokenize!(bits_hex_empty => "0bx" = [Bits]);
test_tokenize!(bits_hex_underscores => "0bx012_3456_789a_bcdef" = [Bits]);
test_tokenize!(bits_hex_start_underscores => "0bx_012_3456_789a_bcdef" = [Bits]);
test_tokenize!(bits_hex_upper => "0bx0123456789ABCDEF" = [Bits]);
test_tokenize!(bits_oct => "0bo01234567" = [Bits]);
test_tokenize!(bits_oct_empty => "0bo" = [Bits]);
test_tokenize!(bits_oct_state_underscores => "0bo_01_2345_67" = [Bits]);
...
test_tokenize!(kw_iter => "iter" = [KwIter]);
