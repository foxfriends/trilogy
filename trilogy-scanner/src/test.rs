...
test_tokenize!(op_tilde_double => "~~" = [OpTilde OpTilde]);
test_tokenize!(op_tilde_lt => "~<" = [OpTilde OpLt]);
test_tokenize!(op_gt_tilde => ">~" = [OpGt OpTilde]);
test_tokenize!(op_shr => "~>" = [OpShr]);
test_tokenize!(op_shl => "<~" = [OpShl]);
test_tokenize!(op_shrex => "~~>" = [OpShrex]);
test_tokenize!(op_shlex => "<~~" = [OpShlex]);
test_tokenize!(op_shrap => ">~>" = [OpShrap]);
test_tokenize!(op_shlap => "<~<" = [OpShlap]);
...
test_tokenize!(op_shrex_eq => "~~>=" = [OpShrexEq]);
test_tokenize!(op_shlex_eq => "<~~=" = [OpShlexEq]);
test_tokenize!(op_shrap_eq => ">~>=" = [OpShrapEq]);
test_tokenize!(op_shlap_eq => "<~<=" = [OpShlapEq]);
